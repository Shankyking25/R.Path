    ...
    return (
        <>
                <div  style={{textAlign:"center"}}>
                    <br/>
               <h1> Aptitude Prepration for Gov. Job </h1>
               <hr/>
       ...
       <Container fixed   >
			...
			<Grid   container md={12}  sm={12} xs={12} lg={12} style={{ height:"auto", marginTop:"10px"}} >
                   	...
                   	<Grid item  md={8}  sm={8} xs={8} lg={8}  >   
                        <br/>
                        <h1> The Complete Aptitude Prepration for Government Job Bootcamp From Zero to Hero in Hindi, English</h1>
                          <hr/>
                          <br/>
                          <p>Learn Aptitude like a Professional Start from the basics and go all the way to crack or clear any government exam. </p>
                          <br/>
